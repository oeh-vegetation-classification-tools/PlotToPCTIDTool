                                     ...
                                     HTML("<table style='border:none;'>
                                           ...
                                           HTML( paste0("
                                                ...
                                                To use this tool please upload standard floristic survey site data using the browse button to the left.
                                                 ...
                                                 The Flora surveys module of the BioNet Atlas application has been set up to store and export data ready for direct upload to this tool. If you haven’t yet done so, first enter your standard floristic survey data into the Flora surveys module of the BioNet Atlas application and then export it. A quick guide on entering and extracting plot data in BioNet Atlas Flora surveys is <a href='https://www.environment.nsw.gov.au/research-and-publications/publications-search/entering-and-extracting-flora-plot-data-in-bionet-atlas' rel='external' target='_blank' class='external'>available.</a> Instructional videos are also <a href='https://vimeo.com/showcase/11306941' rel='external' target='_blank' class='external'>available.</a>
                                                 </p><p style='text-align:justify;padding:1px 15px 1px 2px;'>
