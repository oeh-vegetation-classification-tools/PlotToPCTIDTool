                                   ...
                                   fluidRow(
                                     ...
                                     HTML("<table style='border:none;'>
                                           ...
                                           HTML( paste0("
                                                ...
                                                The BioNet Atlas Systematic Survey flora survey database has been set up to store and export data ready for direct import into this tool. If you haven’t yet done so, please enter your full floristic site data into BioNet Atlas Systematic Survey flora survey database and then export it using the 'Export to Plot to PCT ID tool' function. 
                                                 </p><p style='text-align:justify;padding:1px 15px 1px 2px;'>
                                                Data imported into this tool is assumed to have been exported from the BioNet Atlas Systematic Survey flora survey database, which applies the required taxonomic treatment and cover and abundance score conversions. Importing data that hasn't had the treatments and conversions applied may give unreliable results.
                                                 </p><p style='text-align:justify;padding:1px 15px 1px 2px;'>
                                                 Once you have uploaded your data and viewed the data checks, click on the 'Analyse data' button to proceed. Once the analysis is complete, click to the PCT Matching Results section.
                                                 </p><p style='text-align:justify;padding:1px 15px 1px 2px;'>
                                      ...
                                      tabPanel("Environmental thresholds", value=2,
                                               fluidRow(
                                                 HTML("<table style='border:none;width:100%;'>
                                                      ...
                                                      <td style='vertical-align:top;width:50%'>
                                                      <p style='text-align:justify;padding:5px;'>
                                                        This analysis shows how your site(s) fits within the calculated typical environmental range for matched PCTs. The variables used are elevation, average annual rainfall and average annual temperature. This is a guide only. If your site(s) is outside the typical environmental range, a closer examination is needed to assess whether the site can still be assigned to the matched PCT. 
                                                        The PCTs to which your site is most closely floristically related are included in this table. PCTs are ranked by the distance to centroid for each site (refer to the Centroid matches tab). The most closely matched PCT is listed as PCT_Match_1 and so on. You can use the search bar on the upper right to filter to specific sites or vegetation types.
                                                        Typical environmental ranges have only been calculated for quantitative PCTs with 5 or more sites. Where 'NA' is returned in the table it means the matched PCT has less than 5 sites. In that case please refer to the known maximum and minimum values for each environmental variable in the PCT profile.
                                                      </p>
                                                      </td>
