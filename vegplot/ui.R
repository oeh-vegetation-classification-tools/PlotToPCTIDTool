                                                ...
                                                <div class='rowI'>
                                                   ...
                                                   <div class='colI'style='padding:5px;'>
                                                        <p style='text-align:justify;padding:1px 1px 1px 2px;'>
                                                            ...
                                                            <p style='text-align:justify;padding:1px 10px 1px 2px;'>
                                                            <span style='color:#567621;'>This tool is part of BioNet, the NSW biodiversity data repository.</span> Data on all NSW PCTs is accessible in the <a href='https://www.environment.nsw.gov.au/NSWVCA20PRapp/LoginPR.aspx' rel='external' target='_blank' class='external'>BioNet Vegetation Classification</a> public application. Systematic floristic survey site data is accessed in the Flora surveys module of the <a href='https://www.environment.nsw.gov.au/atlaspublicapp/UI_Modules/YETI_/FloraSearch.aspx' rel='external' target='_blank' class='external'>BioNet Atlas</a> application. 
                                                            </p>
                                                            <p style='text-align:justify;padding:1px 10px 1px 2px;'>
                                                            <span style='color:#567621;'>A Plot to PCT Assignment Tool <a href='' rel='external' target='_blank' class='externalgreen'>User Guide</a> is available.</span> Details of the classification project underpinning the quantitative PCTs in eastern NSW can be found in the <a href='' rel='external' target='_blank' class='external'>Revised Classification of Plant Communities of Eastern NSW</a> paper. 
                                                            </p>
                                                            <p style='text-align:justify;padding:1px 10px 1px 2px;'>
                                                            The Plot to PCT Assignment Tool was developed by the Department of Planning, Industry and Environment (DPIE) and the University of New South Wales (UNSW) with funding from the Australian Research Council (ARC) grant number LP150100972.
                                                            </p>
                                     ...
                                     HTML("<table style='border:none;'>
                                           ...
                                           HTML( paste0("
                                                ...
                                                To use this tool please upload standard floristic survey site data using the browse button to the left.
                                                 ...
                                                 The Flora surveys module of the BioNet Atlas application has been set up to store and export data ready for direct upload to this tool. If you haven’t yet done so, first enter your standard floristic survey data into the Flora surveys module of the BioNet Atlas application and then export it by selecting the 'PCT classification taxonomic assignment' and using the 'Plot to PCT assignment tool' output format.
                                                 </p><p style='text-align:justify;padding:1px 15px 1px 2px;'>
                                           ...
                                           HTML("</td>
                                                <td style='vertical-align:top;background-color:#ccd6bc;'>
                                                    ...
                                                    <p style='padding:5px 5px 5px 10px;'>This tool relies on the use of standard taxonomic treatments for flora species names. It uses the NSW CAPS list for the definitive reference, a list managed by DPIE and available on request. The CAPS list has been further amended to provide consistent epithets across 50,000 sites in eastern NSW. It is important that species data for new sites is standardised to this treatment. The Flora surveys module of the BioNet Atlas application has this functionality built in and available for your use.</p>
                                                    <hr/> 
                         ...
                         tabPanel("PCT Matching Results",
                                  fluidRow(
                                    ...
                                    tags$p("This section of the tool allows you to assess your sites against the most closely floristically related PCTs. 
                                       ...
                                       If you wish to try an alternative method, or you are obtaining weak results using the centroid matches method, it may be suitable to examine results in the ‘Characteristic Species Method‘ tab."
                                  ...
                                  fluidRow(
                                    tabsetPanel(
                                      ...
                                      tabPanel("Map View", value=3,
                                               fluidPage(
                                                 HTML("<br/>Displayed are: sites drawn from the Flora surveys module of the BioNet Atlas application that are classified to a quantitative PCT; sites uploaded to this Plot to PCT Assignment Tool during the current session.<br/>
                                     ...
                                     fluidRow(
                                        ...
                                        HTML("<table style='border:none;width:100%;'>
                                            <tr>
                                             ...
                                             <td style='vertical-align:top;width:50%'>
                                              <p style='text-align:justify;padding:5px;'>
                                                It is recommended that you first evaluate your data using the ‘Centroid Matches‘ tab. The ‘Characteristic Species Method‘ tab provides an alternative if you are obtaining weak results using centroid matching. 
