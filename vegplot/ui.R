                                     ...
                                     HTML("<table style='border:none;'>
                                           ...
                                           HTML( paste0("
                                                ...
                                                As your data is uploaded, some simple data checks will be run. When you see the 'Upload complete' message you can view the results of these checks below. Once you have viewed the data checks, click on the 'Analyse data' button to proceed with analysis. Once the analysis is complete, click to the 'PCT Matching Results' tab in the menu bar above.
                                                 </p><span style='text-align:padding:10px 10px 1px 10px;color:#567621;font-weight:bolder;'> User alert</span>
                                                 </p><p style='text-align:justify;padding:1px 15px 1px 2px;'>
                                                An update to the NSW Plant Community Type master list is scheduled to occur between 22 November and 22 December 2023 (version C2.0). This includes updates to the PCT taxonomic and environmental data used by this tool. Over this period users may experience mismatches with species names in .csv input files (mismatches will be reported in the 'Uploaded data checks' table below). This may limit the performance of the tool over this period. If you experience difficulties, or have urgent applications for the tool, please contact us at bionet@environment.nsw.gov.au. For further information about the PCT updates see this <a href='https://environment.nsw.gov.au/news/plant-community-type-changes-annual-update' rel='external' target='_blank' class='external'>BioNet news article</a>.
                                                 </p><p style='text-align:justify;padding:1px 15px 1px 2px;'>
